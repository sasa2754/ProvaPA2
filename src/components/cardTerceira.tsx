...
export const Card = ({id, name, ki, maxKi, race, gender, description, image} : ICard) => {
    return (
        <div className="dark:bg-sky-800 dark:text-white cursor-pointer rounded-xl p-3 w-72 object-cover flex flex-col items-center justify-between bg-neutral-50 shadow-xl transition ease-in-out hover:scale-110">
